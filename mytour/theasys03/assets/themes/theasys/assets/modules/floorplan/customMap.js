THEASYS.theme.modules.floorplan.customMap = {

    marker : vars.paths.static+'/themes/'+vars.theme+'/assets/modules/floorplan/img/markers/theasys_marker.png',
    marker_width : 25,
    marker_height : 36,
    ...
    loadCustomMap : function( position ){
        ...
        if( 'floorplan' in THEASYS.cache.obj.tours[tour_rnd].tour ){
            ...
            if( typeof floorplan === 'object' ){
                ...
                this.floorplaRadarElement = $('#floorplan_radar');
                ...
                $("#floorplan_img").one("load", function() {

                    var map_custom_img_wrapper = $('#floorplan_img_wrapper');
    ...
    loadCustomMapPins : function(floorplan){
        ...
        if( 'pins' in floorplan ){
            ...
            var dimensions = document.getElementById("floorplan_img").getBoundingClientRect();

            var img = $('#floorplan_img');
            ...
            $('#floorplan_img_pins').append(html);

            var that = this;

            $('#floorplan_img_pins').on('click','span',function(){
    ...
    customMapPinsTitles : function(b){
      ...
      if( b ){
        ...
        $('#floorplan_img_pins').each(function(){
    ...
    setCustomMapRadar : function(){
        ...
        $('#floorplan_img_pins span').removeClass('active');
        ...
        $('#floorplan_img_pins span').each(function(){
    ...
    adjustCustomMapPins : function(){
        ...
        var floorplan_radar = $('#floorplan_radar');
        ...
        $('#floorplan_img_pins span').each(function(index){
    ...
    rotateCustomMapRadar : function(deg){
        ...
        if( id ){
            ...
            var fap = $('#floorplan_img_pins').find('span[data-panorama="'+this.floorplanActivePin+'"]');
    ...
    adjustImage : function(){
        ...
        var floorplan_img = $('#floorplan_img');
