<template>
  <div class="mt-10 flex flex-col">
    ...
    <div class="relative">
      ...
      <div class="flex sm:hidden overflow-x-hidden pt-0 xs:pt-20 w-full">
    ...
    <div class="py-10 mx-5 sm:mt-24">
      <div class="flex">
        ...
        <!-- mobile aos creating problem. because of that code duplication-->
        <div class="xs:hidden sm:w-1/2 sm:max-w-md sm:-mt-10">
          <h2
          ...
          <ul class="text-left">
            <li class="content">
              ...
              Route is designed individually, according to your wishes, habits
              and preferences.
            </li>
            <li class="content">
              <span class="bullet"></span>
        ...
        <div
          ...
          class="hidden xs:block sm:w-1/2 sm:max-w-md sm:-mt-10"
        >
          <h2
            class="section-title font-semibold text-center sm:text-left mb-10"
          >
