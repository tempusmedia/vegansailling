          ...
          <div class="modal-content">
            ...
            <div class="relative z-30 mx-8 -mt-36 sm:mt-0 sm:mx-16">
              <div class="hidden w-full mb-8 sm:block sm:w-2/3">
                <img class="-mt-32 cook-mask" src="/images/skipper02.jpg" />
              </div>
                ...
                <div class="flex items-start pt-8">
                  <div class="ml-0 sm:ml-10">
                    <p class="mb-3 route-modal-title">
                      ...
                      from knotsand weather, to literature about sailing past to
                      sailing future.
                    </p>
                    <p class="route-modal-body">
                      Since 2018 I've been cooperating with “NAS” sailing center
                      from Krk, Croatia, as a sailing instructor at different
                      sailing courses, from beginners’ course and navigation
                      course to the skipper training where I met Filip, and
                      decided to join him in this beautiful idea of vegan
                      sailing.  I've sailed most of the Adriatic and learned
                      where the best spots are to chill out, snorkel, have a
                      party, and places to avoid because they are tourist traps.
                      By nature, I'm energetic and outgoing, and I love to share
                      sailing stories, and show you the sailor tricks on the
                      seas.
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-start pt-8">
                  <div class="ml-0 sm:ml-10">
                    <p class="route-modal-body">
                      ...
                      flirting with becoming vegan. My best sailing experiences
                      were vegan cruises because the vibe on the boat is so pure
                      and positive that the dolphins feel that energy and join
                      us by jumping around the sailboat.
                    </p>
                  </div>
                </div>
                <div class="relative">
