      ...
      return {
        ...
        items: {
          q1: {
            ...
            content: this.$t('components.qna.what_content_private'),
            open: false,
          },
          q2: {
      ...
      return {
        ...
        items: {
          ...
          q3: {
            ...
            content: this.$t('components.qna.safety_content'),
            open: false,
          },
          q4: {
            title: this.$t('components.qna.selection'),
            content: this.$t('components.qna.selection_content'),
            open: false,
          },
          q5: {
